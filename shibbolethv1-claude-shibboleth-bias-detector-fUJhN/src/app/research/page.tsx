...
export default function ResearchPage() {
  ...
  const fullPrompt = `${SYSTEM_PROMPT} ${exampleTopic}`;
    ...
    <div className="min-h-screen grid-pattern">
      ...
      <div className="border-b border-zinc-800">
        <div className="max-w-4xl mx-auto px-4 py-4 flex items-center justify-between">
          <Link href="/" className="font-mono text-white tracking-wider hover:text-sky-400 transition-colors">
            ← SHIBBOLETH
          </Link>
          <span className="font-mono text-xs text-zinc-600">// RESEARCH</span>
        </div>
      </div>
      ...
      <div className="max-w-4xl mx-auto px-4 py-16">
        <div className="mb-12">
          ...
          <h1 className="font-mono text-3xl md:text-4xl text-white mt-2 tracking-wider">
        ...
        <section className="mb-16">
          <h2 className="font-mono text-xl text-white mb-6 flex items-center gap-2">
          ...
          <div className="border border-zinc-800 bg-zinc-950 p-6 space-y-4">
            <p className="text-zinc-400">
              ...
              exactly one word: <span className="text-green-500 font-mono">GOOD</span> or{' '}
              <span className="text-red-500 font-mono">BAD</span>.
            </p>
            <p className="text-zinc-400">
        ...
        <section className="mb-16">
          ...
          <div className="grid md:grid-cols-2 gap-4">
            {MODELS.map((model) => (
              <div key={model.id} className="border border-zinc-800 bg-zinc-950 p-4">
        ...
        <section className="mb-16">
          ...
          <div className="border border-zinc-800 bg-zinc-950">
            ...
            <pre className="p-4 font-mono text-sm text-zinc-300 whitespace-pre-wrap overflow-x-auto">
{SYSTEM_PROMPT}
            </pre>
          </div>
...
{exampleRequest}
          ...
          <div className="mt-4 space-y-2">
            <p className="text-zinc-600 text-sm">
              <span className="text-zinc-400 font-mono">temperature: 0</span> — Ensures deterministic responses
            </p>
            <p className="text-zinc-600 text-sm">
              <span className="text-zinc-400 font-mono">max_tokens: 10</span> — Forces brevity
            </p>
          </div>
        </section>
        ...
        <section className="mb-16">
          ...
          <div className="border border-zinc-800 bg-zinc-950 p-6 space-y-4">
            <div className="flex items-start gap-4">
              <span className="font-mono text-green-500 text-lg">GOOD</span>
              <p className="text-zinc-400">
                The model&apos;s training leads it to associate positive value with this topic by default.
              </p>
            </div>
            <div className="flex items-start gap-4">
              <span className="font-mono text-red-500 text-lg">BAD</span>
              <p className="text-zinc-400">
            ...
            <div className="flex items-start gap-4">
              <span className="font-mono text-yellow-500 text-lg">REFUSED</span>
              <p className="text-zinc-400">
        ...
        {/* CTA */}
        <div className="text-center border-t border-zinc-800 pt-16">
          <Link
            href="/"
